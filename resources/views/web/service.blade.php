                    ...
                    <div class="content">
                        <article class="post_item_single">
                            <div class="post_content">
                                ...
                                <div class="copypress-custom-bg-8 scheme_dark">
                                    <div class="content_wrap sc_layouts_column_icons_position_left">
                                        ...
                                        <div class="sc_title sc_title_default">
                                            ...
                                            <h2 class="sc_item_title sc_title_title sc_align_center sc_item_title_style_yellow_sub">We Proud Of Our Work</h2>
                                        </div>
                                ...
                                <!-- /Counters -->
                                <!-- Testimonials -->
                                <div class="copypress-custom-bg-5 testimonials_style_1">
                                    <div class="content_wrap sc_layouts_column_icons_position_left">
                                        <div class="empty_space height_4_6em"></div>
                                        <div class="trx_addons_columns_wrap">
                                            ...
                                            <div class="empty_space height_4em"></div>
                                            <figure>
                                                <img src="{{url('images/img38.jpg')}}" alt="" />
                                            </figure>
                                        </div>
                                        </div>
                                    ...
                                    <div class="content_wrap sc_layouts_column_icons_position_left">
                                        ...
                                        <div class="brands">
                                            <div class="gallery gallery-columns-6 gallery-size-full">
                                                ...
                                                <div class="gallery-icon landscape">
                                                    <a href="#">
                                                        <img src="{{url('images/img32.jpg')}}" alt="" />
                                                    </a>
                                                </div>
                                            </figure>
                                            </div>
